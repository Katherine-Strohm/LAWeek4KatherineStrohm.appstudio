...
const cacheName = 'LAWeek4KatherineStrohm-2021-09-15 14:42:07.915679'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWeek4KatherineStrohm'.length) === 'LAWeek4KatherineStrohm') {
